function inicializaAPI() {
    ...
    function leeDatosSCORM() {
        ...
        if (revisaConexion) {
            ...
            var elRefDatos = laUrlBase + 'Lecciones/' + usuarioId + '/' + elCurso + '/objeto_' + that['CursoId' + elContenido] + '/SCORM_12/';
    ...
    function escribeDatosSCORM(param, val) {
        ...
        if (revisaConexion) {
            ...
            var elRefDatos = laUrlBase + 'Lecciones/' + usuarioId + '/' + elCurso + '/objeto_' + that['CursoId' + elContenido] + '/SCORM_12/' + nuevoParam + '';
            ...
            firebase.database().ref(elRefDatos).once('value').then(function (snapshot) {
                ...
                var paramActual = snapshot.child(nuevoParam).val();
                console.log('paramActual', paramActual);
